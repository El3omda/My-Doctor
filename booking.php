...
<head>
  ...
  <title>اختيار طبيب لحجز موعد</title>
...
<body>
  ...
  <div class="booking">
    ...
    <form class="doctor-filter" action="<?php echo $_SERVER['PHP_SELF'] . '?P=Booking'; ?>" method="POST">
    ...
    <div class="doc-result">
      ...
      ';
        ...
        <div class="box">
          ...
          <div class="btn">
            <a href="compelete2.php?id=' . $rowDD['ID'] . '"><i class="fa fa-angle-left"></i> حجز موعد</a>
          </div>
        </div>
      ';
        }
